...
public class HotelTest {
    ...
    public void getsStartingOffset() throws IOException {
        ...
        Assertions.assertEquals(74, offset);
    }
    ...
    public void cannotReadFromInvalidFile() {
        ...
        String errorMsg = Assertions.assertThrows(IllegalArgumentException.class, () -> Hotel.readHotels(filename)).getMessage();
        Assertions.assertTrue(errorMsg.contains(filename));
    }
    ...
    public void readsAllUndeletedHotelsFromGivenFile() throws IOException {
        ...
        Assertions.assertTrue(result.contains(contained));
    }
    ...
    public void readsAllHotelsFromGivenFile() throws IOException {
        ...
        Assertions.assertFalse(result.contains(deleted));
    }
